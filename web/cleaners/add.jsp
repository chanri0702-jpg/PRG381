...
<%
    request.setAttribute("pageTitle", "Add Cleaner");
...
<head>
    ...
    <title>Add Cleaner | Cleaning Inventory & Issuance System</title>
    ...
    <main class="main-content cleaners-page">
        ...
        <div class="page-header">
            ...
            <div class="page-header-text">
                <p>
                    Capture the cleaner's personal details, contact information
                    and assigned campus.
                </p>
            </div>
        ...
        <form class="cleaner-form"
              method="post"
              action="<%= request.getContextPath() %>/cleaners?action=create">
