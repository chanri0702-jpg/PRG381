...
<head>
    ...
    <title>Edit Supplier | Cleaning Inventory & Issuance System</title>
    ...
    <main class="main-content suppliers-page">
        ...
        <div class="page-header">
            ...
            <div class="page-header-text">
                <p>
                    Update the supplier business, office address and primary
        ...
        <form class="supplier-form"
              method="post"
              action="<%= request.getContextPath() %>/suppliers?action=update">
